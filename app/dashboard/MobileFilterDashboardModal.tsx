...
interface MobileFilterLotesModalProps {
    open: boolean;
...
const MobileFilterDashboardModal: React.FC<MobileFilterLotesModalProps> = ({
                                                                               open,
                                                                               onOpenChange,
                                                                               initialFilter,
                                                                               onFilter,
    ...
    const handleFilter = () => {
        ...
        !validaDataFinalMenorQueDataInicial() &&
        onFilter({
            ...filter,
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="p-4 max-w-[90vw] rounded-lg">
                <DialogHeader>
                    <DialogTitle>Escopo de Pesquisa</DialogTitle>
                </DialogHeader>
                {message && (
                    <MensagemPadrao mensagem={message.mensagem} tipo={message.tipo}/>
                )}
                ...
                <div className="flex justify-end gap-4 mt-4">
                    <BotaoPadrao variant="outline" onClick={onCancelAction} name={"Cancelar"}
                                 icon={<Ban className="w-4 h-4 font-bold"/>}/>
                    <BotaoPadrao variant="outline" onClick={handleFilter} name={"Ok"}
...
export default MobileFilterDashboardModal;